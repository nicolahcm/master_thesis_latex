...
These observations suggest that the RR estimate of second order (eq. \eqref{eq: moreAccurateEstimate}) and the estimate in equation \eqref{eq: estimateRRwithbeta} do not hold true.
 However, all this does not imply that the double step RR extrapolation (described in Subsection \ref{subsection: multiStepRR} and equation \eqref{eq: multiStepRR}) is useless: we remind that $\left\{ \bar{\psi}^n_{_{RR,3}} \right\}_{n \in \mathbb{N}}$ does converge to $\psi$ (as $n\to +\infty$), but the convergence rate \eqref{eq: rr3 convergence rate} might not hold true since the second order RR estimate \eqref{eq: moreAccurateEstimate}, from which it follows, seems not to hold. 
\\
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, height=65mm]{c1n/comp_times.png}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, height=60mm]{coefficients_test_2/output.png}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, height=55mm]{coefficients_test_2/n = 16.png}
  \caption{(a) $n = 16$}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth, height=55mm]{coefficients_test_2/n = 64.png}
  \caption{(a) $n = 64$}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, height=55mm]{coefficients_test_2/n = 256.png}
  \caption{(a) $n = 256$}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, height=55mm]{coefficients_test_2/c_1^n.png}
