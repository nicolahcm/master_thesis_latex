...
In this chapter we will run some numerical tests to get a hold on the hybrid Euler scheme. For the code refer to Appendix \ref{appendix: hybridEulerScheme}.
\\
